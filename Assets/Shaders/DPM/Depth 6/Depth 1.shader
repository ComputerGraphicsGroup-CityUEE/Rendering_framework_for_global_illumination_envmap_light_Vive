    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(appdata v)
            {
                ...
                float4 hp = mul(_gWorldToLightCamera6, mul(unity_ObjectToWorld, v.vertex));
                ...
                //o.pos.z =  (sfunc(focal_length, hp.xyz) - 0.01) / (farPlane - 0.01);
